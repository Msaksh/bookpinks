  ...
  return (
    <Box >
      <Box className='bg-[#ffde71] flex flex-col items-center gap-2 p-4'>
        <Typography className="font-eagleLake text-[15px] md:text-[20px] italic font-bold">Exclusive Limited-Time Offer: Enjoy Extra 10% Off! Unlock Special Savings Before Time Runs Out!!!</Typography>
        ...
        <Typography className="font-poppins text-[15px] md:text-[20px] text-[#444444] font-semibold">Use This Coupon Code - SMMR10</Typography>
      </Box>
      ...
      <Box className="bg-[url('https://bookpinks.com/wp-content/uploads/2023/10/rm309-adj-0555-min-1-jpg.webp')] bg-cover	bg-center	 min-h-screen py-20">
        <Typography className="text-lg md:text-4xl text-[#0B0B0B] font-caudex font-bold text-center">Book Pink's marketing tools assist you in accomplishing your goals.</Typography>

        <Box className=" py-16">
          <Box className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Box className="text-start md:text-center mb-20 ">
              <Box className="flex justify-start md:justify-center items-center h-[63px] w-[64px] p-5 rounded-full border-[3px] group hover:border-teal-300 duration-300 border-teal-600 md:mx-auto mb-4">
      ...
      <Box className='bg-[radial-gradient(at_bottom_right,_#FFFFFF_0%,_#0DA8AA_53%)] min-h-screen py-20 '>
        ...
        <Box className='max-w-[1200px] mx-auto px-9 py-3'>
          <Box data-aos="zoom-in-up" className='flex flex-col md:flex-row items-center bg-white max-w-7xl rounded-2xl px-6 md:px-12 py-10 gap-5 '>
            <Box className='md:mr-10 border-[3px] p-2 md:p-6 rounded-full border-[#EB008A]'>
              <i className="fa fa-globe text-[25px] md:text-[50px] text-[#EB008A]"></i>
            </Box>
            <Box>
              <Typography className="text-xl text-black font-poppins font-semibold mb-5 text-center md:text-start">Global Impact</Typography>
              <Typography className="text-base text-[#030303] font-poppins font-normal text-center md:text-start">Global Impact is a word used to describe the extent to which your book has resonated, inspiring profound emotions, sparking debates, and leaving an enduring mark on people's thoughts and cultures across the world.</Typography>

            </Box>
          </Box>
        </Box>
        <Box className='max-w-[1200px] mx-auto px-9 py-3'>
          <Box data-aos="zoom-in-up" className='flex flex-col-reverse md:flex-row items-center bg-white max-w-7xl rounded-2xl px-6 md:px-12 py-10 gap-5 '>

            <Box>
              <Typography className="text-xl text-black font-poppins font-semibold mb-5 text-center md:text-start">Email List
              </Typography>
              <Typography className="text-base text-[#030303] font-poppins font-normal text-center md:text-start">We maintain a database of readers' email addresses so that we may interact with them directly. Subscribers receive news, promotions, and updates about the publication of your books, resulting in readers engagement.</Typography>
            </Box>
            <Box className='md:ml-10 border-[3px] p-2 md:p-6 rounded-full border-[#EB008A]'>
              <i className="fa fa-table-list text-[25px] md:text-[50px] text-[#EB008A]"></i>
            </Box>
          </Box>
        </Box>
        <Box className='max-w-[1200px] mx-auto px-9 py-3'>
          <Box data-aos="zoom-in-up" className='flex flex-col md:flex-row items-center bg-white max-w-7xl rounded-2xl px-6 md:px-12 py-10 gap-5 '>
            <Box className='md:mr-10 border-[3px] p-2 md:p-6 rounded-full border-[#EB008A]'>
              <i className="fa fa-book-open-reader text-[25px] md:text-[50px] text-[#EB008A]"></i>
            </Box>
            <Box>
              <Typography className="text-xl text-black font-poppins font-semibold mb-5 text-center md:text-start">Engage Readers</Typography>
              <Typography className="text-base text-[#030303] font-poppins font-normal text-center md:text-start">With a significant global community of dedicated Instagram and Twitter followers, we're offering an excellent opportunity to boost your readership. Increase the success of your work by partnering with writers and distributors along with creative book promotion approaches.</Typography>
            </Box>
          </Box>
        </Box>
        <Box className='max-w-[1200px] mx-auto px-9 py-3'>
          <Box data-aos="zoom-in-up" className='flex  flex-col-reverse md:flex-row items-center bg-white max-w-7xl rounded-2xl px-6 md:px-12 py-10 gap-5 '>
            ...
            <Box>
              <Typography className="text-xl text-black font-poppins font-semibold mb-5 text-center md:text-start">Target Keyword </Typography>
              <Typography className="text-base text-[#030303] font-poppins font-normal text-center md:text-start">In order to boost search engine visibility, generate relevant traffic, and improve discoverability, we strategically target words or phrases that we believe are relevant to your books and readers and use them to optimize your website.
              </Typography>
            </Box>
            <Box className='md:ml-10 border-[3px] p-2 md:p-6 rounded-full border-[#EB008A]'>
              <i className="fa fa-key text-[25px] md:text-[50px] text-[#EB008A]"></i>
            </Box>
          </Box>
        </Box>
        <Box className='max-w-[1200px] mx-auto px-9 py-3'>
          <Box data-aos="zoom-in-up" className='flex flex-col md:flex-row items-center bg-white max-w-7xl rounded-2xl px-6 md:px-12 py-10 gap-5 '>
            <Box className='md:mr-10 border-[3px] p-2 md:p-6 rounded-full border-[#EB008A]'>
              <i className="fa fa-images text-[25px] md:text-[50px] text-[#EB008A]"></i>

            </Box>
            <Box>
              <Typography className="text-xl text-black font-poppins font-semibold mb-5 text-center md:text-start">Visual Allure
              </Typography>
              <Typography className="text-base text-[#030303] font-poppins font-normal text-center md:text-start">We offer Visual allure which highlights the visually appealing and captivating aspects of your book, attracting readers with striking cover designs, graphics, and imagery that elevate the reading experience overall.
      ...
      <section>
        ...
        <Box className='bg-black'>
          <Box className='max-w-[1200px] mx-auto flex flex-col md:flex-row items-center '>
            <Box className="md:w-2/5 mt-4 md:mt-0">
            ...
            <Box className='block md:hidden mt-10'>
              <img src="https://bookpinks.com/wp-content/uploads/2024/06/pngegg10.png" width={200} height={100} alt="discount" />
            </Box>
            <Box className='md:w-3/5 min-h-[200px] p-10 relative'>
              <Typography className="font-eagleLake font-semibold text-4xl text-center mb-4 text-[#E4322B] italic">This Summer
              </Typography>
              <Typography className="font-caudex font-semibold text-xs md:text-xl text-center mb-4 text-[#F3FFF1]">Exclusive Limited-Time Offer: Enjoy Extra 10% Off! Unlock Special Savings Before Time Runs Out!!!
              </Typography>
              <Box>
                <Typography className="font-eagleLake text-xs md:text-xl font-semibold text-center text-[#F3FFF1]">
                  “Hurry, limited-time offer!”
                </Typography>
                <Typography className="font-eagleLake text-xs md:text-xl text-center text-[#E4322B]">
                  Don't Miss Out
                </Typography>
              </Box>
          ...
          <Box className='py-20 max-w-[1200px] mx-auto'>
            ...
            <Grid container spacing={3} className="p-2">
              {plansDetail.map((item, index) => (
                <Grid item xs={12} sm={6} md={4} key={index} data-aos={item.animate}>
                  <Plans plan={item} />
                </Grid>
