...
const CardBig = ({ bgColor1, bgColor2, text1, text2, text3, img }) => {
  ...
  return (
    ...
    >
      ...
      <Typography className="text-[65px] leading-9 text-[#ffffff5e] font-tahoma font-black mb-6 tracking-tighter">{text3}</Typography>
