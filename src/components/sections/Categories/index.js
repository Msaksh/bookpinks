...
const Categories = () => {
  return (
    <Box className='mb-24 px-2 md:px-8'>
      <Grid container spacing={4}>

        <Grid item xs={12} sm={6} md={6} lg={3} data-aos="fade-right">
