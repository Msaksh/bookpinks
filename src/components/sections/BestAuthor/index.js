          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={3} className="flex flex-col items-center md:items-start mb-10 ">
              <Box data-aos="zoom-in">
                <Typography className="md:text-[38px] font-poppins font-semibold leading-none">BEST <br className="hidden md:block" /> AUTHOR
                </Typography>
              </Box>
              <Box className='w-12 h-[2px] bg-[#e168cc] mt-6'></Box>
              <Box data-aos="fade-right" className="w-60 h-60 bg-white p-[3px] rounded-full hover:shadow-[0_0px_10px_rgba(0,0,0,0.3)] my-10 ">
            ...
            <Grid item xs={12} sm={4}>
              <Typography className="md:text-[25px] font-raleway font-semibold mb-5">Kya Lane
              </Typography>
            ...
            <Grid item xs={12} sm={5} className="flex flex-col items-center">
              <Typography className="text-[25px] font-raleway font-semibold mb-5" data-aos="zoom-in">Related Book
              </Typography>
              <Box data-aos="fade-left" className='w-40 md:w-60 md:h-[411px]'>
                <img src="https://bookpinks.com/wp-content/uploads/2024/02/Kya-lane3-300x500.webp" />
              </Box>
              <Typography className="w-40 md:w-60 text-center font-playfair">Playing Forbidden Games: An Enemies to Lovers Sports Romance Collection</Typography>
            </Grid>
