  ...
  return (
    <Box className='px-2 md:px-8'>
      <Box className="bg-gradient-to-r from-from-grey to-to-grey py-8 h-[374px] md:h-full md:py-48 rounded-3xl relative mb-12 overflow-hidden ">
        <Box className='absolute w-[300px] md:w-[490px] left-2/3 md:left-1/2 -translate-x-1/2 top-[84%] md:top-1/2 -translate-y-2/3 md:z-10'>
        ...
        <Box className='ms-7 md:ms-32' data-aos='fade-up'>
          <Typography className="md:text-3xl font-medium font-poppins text-black mb-4">Best</Typography>
          <Typography className="text-xl md:text-7xl font-poppins font-bold text-black mb-3">Deals on</Typography>
          <Typography className="text-white text-[12vw] font-black font-montserrat tracking-tighter leading-none">BOOKPINKS!!</Typography>
          <Box className='flex items-center justify-between mr-0 md:mr-36'>
            <Box className='mt-20 '>
              <Box className='border rounded-full border-gray-400 bg-white px-6 flex w-5/6 relative md:static  min-w-[25vw] py-1'>
                <CustomTextField
                  id="standard-basic"
